...
#     print("图片数量和标签数量不一致！")
#
# for filename in os.listdir(r"C:\Users\qiangge1573\PycharmProjects\lianxi\20171111001\mnist_digits_images\5"):
# import os
# print(len(os.listdir(r"C:\Users\qiangge1573\PycharmProjects\lianxi\20171111001\mnist_digits_images\5")))
import os
ls = os.listdir(r'C:\Users\qiangge1573\PycharmProjects\lianxi\20171111001')
count = count1 = 0
for i in ls:
    if os.path.isfile(os.path.join(r'C:\Users\qiangge1573\PycharmProjects\lianxi\20171111001',i)):
        count += 1
# for j in ls:
#     if os.path.isfile(os.path.join(r'C:\Users\qiangge1573\PycharmProjects\lianxi\20171111001', j)):
    else:
        count1 +=1
for filename in ls:
    print(filename)
print("文件数量有%s个"%(count))
print("文件夹数量有%s个"%(count1))